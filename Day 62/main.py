...
class CafeForm(FlaskForm):
    ...
    power = StringField("Power Outlets", validators=[DataRequired()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        ...
        with open("cafe-data.csv", mode="a", newline="", encoding="utf-8") as csv_file:
            csv_file.write(
                f"{form.cafe.data},{form.location.data},{form.opening.data},{form.closing.data},{form.coffee.data},{form.wifi.data},{form.power.data}\n"
            )
